...
export const getNetworkInfo = () => {
    ...
    const connection = (navigator as Navigator & { connection?: any; mozConnection?: any; webkitConnection?: any }).connection || 
                       (navigator as Navigator & { connection?: any; mozConnection?: any; webkitConnection?: any }).mozConnection || 
                       (navigator as Navigator & { connection?: any; mozConnection?: any; webkitConnection?: any }).webkitConnection;
...
export const sendTrackingData = async (sessionId: string, type: string, data: any) => {
    try {
